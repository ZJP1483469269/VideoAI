...
namespace TLKJ.WebSys
{
    ...
    public class ChartTool
    {
        ...
        public static ChartTool LoadConfig(int iTypeID)
        {
            ...
            vo.dtConfig = DbManager.QueryData("select * from XT_CHART where CHART_ID='" + iTypeID + "'");
            ...
            vo.dtConfig = DbManager.QueryData("select * from XT_CHART_CONFIG where CHART_ID='" + iTypeID + "'");
            return vo;
        }
    }
}