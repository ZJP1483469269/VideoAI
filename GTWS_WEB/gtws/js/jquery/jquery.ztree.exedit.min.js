...
10):G&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+10);r&&r!=k.treeObj&&r.offset().left<k.treeObj.offset().left&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+r.offset().left-k.treeObj.offset().left)}w.css({top:b.clientY+B-10+"px",left:b.clientX+l-10+"px"});l=a=0;if(r&&r.attr("id")!=k.treeId){var y=v==null?null:o.getNodeCache(k,v);c=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&g.edit.drag.isCopy;a=!!(C&&v===C.tId);i=!!(J&&v===J.tId);l=e.parentTId&&e.parentTId==v;e=(c||!i)&&
