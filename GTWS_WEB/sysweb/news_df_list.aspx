<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_df_list.aspx.cs" Inherits="news_df_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Modify_Event(cKeyID) {
            AjaxOpenDialog('修改地方法规', "news_df_edit.aspx?ID=" + cKeyID, "640px", "480px");
        }
    ...
    <form id="form1" runat="server">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">法律法规-地方法规</h3>
            </div>
            <div>
                <input type="button" value="添加" onclick="AjaxOpenDialog('添加地方法规', 'news_df_edit.aspx', '800px', '650px');" />
            </div>
        ...
        <input type="hidden" id="cls_id" name="cls_id" value="LAW_DF" />
    </form>
</body>
</html>
