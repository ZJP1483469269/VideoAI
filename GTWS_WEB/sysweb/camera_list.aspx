<%@ Page Language="C#" AutoEventWireup="true" CodeFile="camera_list.aspx.cs" Inherits="camera_list" %>
    ...
    <script type="text/javascript">
        ...
        function InitGrid() {
            $('#DBGrid').bootstrapTable({
                url: '/api/rest.ashx?action_type=Camera&action_method=query',         //请求后台的URL（*）
                method: 'get',             //请求方式（*）
                ...
                columns: [
                    ...
                    }, 
                    {
                        ...
                        , formatter: function (value, row, index) {
                           ...
                           // cStr = cStr + "&nbsp;&nbsp;<a href='#' onclick='peizhi(\""+row.id+"\");'>配置</a>";
                            var cStr = "<a href='#' onclick='peizhi(\"" + row.id + "\");'>配置</a>";
                            return cStr;
                        }
                    }
                ]
        ...
        function Modify_Event(cKeyID) {           
            AjaxOpenDialog('修改法规信息', "camera_edit.aspx?ID=" + cKeyID, "640px", "480px");
        }

        function peizhi(cKeyID) {            
            AjaxOpenDialog('配置摄像机信息', "camera_peizhi.aspx?ID=" + cKeyID, "640px", "480px");
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="action_type" name="action_type" value="XT_CAMERA" />
