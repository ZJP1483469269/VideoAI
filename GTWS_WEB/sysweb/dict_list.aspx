<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dict_list.aspx.cs" Inherits="sysweb_dict_list" %>
    ...
    <script type="text/javascript">
        ...
        function InitGrid() {
            $('#DBGrid').bootstrapTable({
                url: '/api/rest.ashx?action_type=Dict&action_method=query',         //请求后台的URL（*）
                method: 'get',             //请求方式（*）
