<%@ Page Language="C#" AutoEventWireup="true" CodeFile="online_list.aspx.cs" Inherits="sysweb_online_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
                   ...
                   },
                   {
                       field: 'notice_title'
                        ...
                        , formatter: function (value, row, index) {
                            ...
                            cStr = cStr + "<a href='#' onclick='Modify_Event(" + row.id + ");'>修改</a>";
        ...
        function AjaxView(vKeyID) {
            OpenAjaxLayer('通知公告', 'notice.aspx?ID=' + vKeyID);
        }
    </script>
</head>
<body>
